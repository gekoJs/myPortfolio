...
export default function ThemeButton() {
  ...
  return (
    <div
      onClick={handleClick}
      onMouseEnter={() => dispatch(hoverOnOffTheme(true))}
      onMouseLeave={() => dispatch(hoverOnOffTheme(false))}
    ...
    >
      {themeDisplayed === "light" ? (
        <svg
          ...
          width="28"
          style={{fill: isHover && isLargerThan770 ? "var(--fillHov)" : "var(--fill)", cursor: "pointer"}}
        >
